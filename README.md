...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-22.1.21-62d6b3">
...
4. Open a supported `ui\_mp.ff` in **Map Menu Editor**, add the map and export the menu.
...
|⚠️|3D map/model previews, MapEnts editing and loader/linker tools; rendering is incomplete.|
|⚠️|Exact reference/BLES and BLUS-30072 UI profiles; other revisions need matching profiles.|

## Still missing

* General PC → RSX shader compilation, full RSX preview execution and particle simulation.
* Complete material/effect fidelity: some maps still show foliage or white-effect issues.
* Universal map, game-region and executable-revision compatibility.
* BLUS console validation, second-console joining and stock-map restoration testing.
